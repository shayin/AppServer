		...
		$(function(){ 
			...
			if(currentPage>3&&currentPage<totalPage-2){
				...
				for(i=currentPage-2;i<=totalPage&&i>0&&i<=currentPage+2;i++){			
					$('#pageIgnoreRight').before('<li id="page' + i +'" ><a href="/AppServer/Home/User/userList/page/' + i +'" >' + i +'</a></li>');	
				}
			...
			$('#btnGoto').click(function(){
				...
				location.href = '/AppServer/Home/User/userList/page/' + $('#goto').val();	
			});				
   ...
   <div class="top"> <!-- 导航开始-->
          ...
          <div class="container-fluid">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="<?php echo U('/Home/Main/main');?>">AppServer服务器管理系统</a>
            </div>
     			...
     			<ul id="main-nav" class="nav nav-tabs navbar-fixed-left nav-stacked nav-static-left" >
                            ...
                            <li>
                                ...
                                <ul id="systemSetting" class="nav nav-list collapse secondmenu" style="height: 0px;">
                                    <div class="second"><li><a href="#"><i class="glyphicon glyphicon-edit"></i>修改密码</a></li></div>
                                    <div class="second"><li><a href="#"><i class="glyphicon glyphicon-asterisk"></i>清除日志</a></li></div>
                                    <div class="second"><li><a href="#"><i class="glyphicon glyphicon-eye-open"></i>日志查看</a></li></div>
                                </ul>
                            </li>                     
                </ul>
                    ...
                    <div class="col-sm-12 col-md-12 clo-xs-12">                 
                          ...
                          <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                              ...
                              <tbody id="list">
                              		<?php $__FOR_START_6169__=0;$__FOR_END_6169__=3;for($i=$__FOR_START_6169__;$i < $__FOR_END_6169__;$i+=1){ if($data[$i][grade] > 0): ?><tr>
                        ...
                        <nav style="text-align:center"> 
                          <ul class="pagination" id="page">
                            <li id="pagePrevious" ><a href="/AppServer/Home/User/userList/page/<?php echo ($currentPage-1); ?>" aria-label="Previous"><span aria-hidden="true">&laquo; 前一页</span></a></li> 
                                <!--入页码标签--> 
                            	
                            <li id="pageNext"><a href="/AppServer/Home/User/userList/page/<?php echo ($currentPage+1); ?>" aria-label="Next"><span aria-hidden="true">后一页 &raquo;</span></a></li>    
                          </ul>
